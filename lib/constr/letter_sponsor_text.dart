      ...
      child: RichText(
        ...
        text: TextSpan(
          ...
          children: <TextSpan>[
            TextSpan(
                text:
                    'Book Sponsorship gives readers the power to affect which books are borrowable on Open Library. '
            ...
            TextSpan(
              text: '“I was frustrated by the lack of diversity in the books '
